...
ConfigurationClient.prototype.fetch = function(configurationId, params, options, callback) {
...
ConfigurationClient.prototype.remove = function(configurationId, params, options, callback) {
  var url = sprintf('/configuration/%(configurationId)s', {'configurationId': configurationId});
  this._remove(url, params, options, callback);
};
