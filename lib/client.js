 ...
 */
var DEFAULT_URL = 'https://fs-staging.k1k.me/v1.0';
...
BaseClient.prototype._request = function(path, method, payload, options, callback) {
  ...
  var extraHeaders = options.headers || {}, expectedStatusCode = options.expectedStatusCode,
      qs = options.queryString || {}, reqOptions, defaultHeaders, url, headers, curlCmd, self = this, parse_json = !this._options.raw;
...
function HeartBeater(username, apiKey, region, options, sessionId, initialToken, timeout) {
