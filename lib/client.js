...
BaseClient.prototype._get = function(path, params, options, callback) {
  this._request(path, 'GET', params, {'expectedStatusCode': 200}, function(err, res) {
    if (err) {
      callback(err);
      return;
    }
...
BaseClient.prototype._remove = function(path, params, options, callback) {
  this._request(path, 'DELETE', params, {'expectedStatusCode': 204}, function(err, res) {
    callback(err);
  });
};
...
SessionsClient.prototype.get = function(id, options, callback) {
  var url = sprintf('/sessions/%(id)s', {'id': id});
  this._get(url, {}, options, callback);
};

SessionsClient.prototype.create = function(heartbeatTimeout, params, options, callback) {
  params = params || {};
  params.heartbeat_timeout = heartbeatTimeout;
  var url = sprintf('/sessions');
...
SessionsClient.prototype.heartbeat = function(sessionId, params, options, callback) {
  ...
  this._request(url, 'POST', params, {'expectedStatusCode': 200}, function(err, res) {
    callback(err);
  });
};
...
ServicesClient.prototype.leave = function(serviceId, sessionId, params, options, callback) {
  params = params || {};
  params.session_id = sessionId;
  var url = sprintf('/services/%(serviceId)s', {'serviceId': serviceId});
...
ServicesClient.prototype.fetch = function(serviceId, params, options, callback) {
  var url = sprintf('/services/%(serviceId)s', {'serviceId': serviceId});
...
ConfigurationClient.prototype.get = function(configurationId, options, callback) {
  var url = sprintf('/configuration/%(configurationId)s', {'configurationId': configurationId});
  this._get(url, {}, options, callback);
};

ConfigurationClient.prototype.update = function(configurationId, options, callback) {
  var url = sprintf('/configuration/%(configurationId)s', {'configurationId': configurationId});
  this._update(url, {}, options, callback);
};

ConfigurationClient.prototype.remove = function(configurationId, options, callback) {
  var url = sprintf('/configuration/%(configurationId)s', {'configurationId': configurationId});
  this._remove(url, {}, options, callback);
};
