...
SessionsClient.prototype.create = function(heartbeatTimeout, params, callback) {
  params = params || {};
  params.heartbeat_timeout = heartbeatTimeout;
  var url = sprintf('/sessions');
  this._create(url, params, {}, callback);
};
...
SessionsClient.prototype.update = function(sessionId, params, callback) {
...
ServicesClient.prototype.join = function(serviceId, sessionId, params, callback) {
  params = params || {};
...
ConfigurationClient.prototype.set = function(configurationId, value, callback) {
  ...
  var url = sprintf('/configuration/%(configurationId)s', {'configurationId': configurationId});
  this._update(url, params, {}, callback);
};
