...
/* HeartBeater */
function HeartBeater(sessionId, initialToken, timeout) {
...
HeartBeater.prototype.start = function() {
  this._startHeartbeating(this._sessionId, this._heartbeatTimeout, this._heartbeatInterval, this._timeoutId, this._nextToken);
};
