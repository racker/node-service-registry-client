...
ServicesClient.prototype.get = function(sessionId, callback) {
  var url = sprintf('/services/%(id)s', {'id': serviceId});
  this._get(url, {}, callback);
};

ServicesClient.prototype.create = function(sessionId, payload, callback) {
  payload = payload || {};
...
ServicesClient.prototype.update = function(sessionId, payload, callback) {
